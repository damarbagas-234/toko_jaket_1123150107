...
void _log(String msg) => debugPrint('[TokoJaket/PaymentPending] $msg');
...
class _VirtualAccountBody extends StatelessWidget {
  ...
  static const List<_BankInfo> _banks = [
    _BankInfo('BCA', '888', AppColors.primary),
    _BankInfo('Mandiri', '888', AppColors.primary),
    _BankInfo('BNI', '8808', AppColors.primaryLight),
    _BankInfo('BRI', '889', AppColors.accent),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Nomor VA ────────────────────────────────────────
          const _SectionLabel(label: 'Nomor Virtual Account'),
          ...
          // ── Cara Bayar ─────────────────────────────────────
          const _SectionLabel(label: 'Cara Pembayaran'),
